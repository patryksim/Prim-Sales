...
function HeaderTwoRows ({navPress, morePress, bgColor='transparent', title='', subTitle='', isHome=false, shadow=true}) {
    ...
    return (
        <View style={{
            ...
            {isHome && (
                <TouchableOpacity onPress={navPress} style={{padding: 10, marginTop: 10}}>
            ...
            <View style={{flex: 1, paddingHorizontal: 10, marginTop: 17}}>
                ...
                <Text style={{fontSize: 14, color: 'white', marginTop: 4}}>{subTitle}</Text>
            </View>
