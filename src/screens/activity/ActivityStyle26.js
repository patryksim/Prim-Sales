        ...
        return (
            <View style={{flexDirection: 'row', alignSelf: 'flex-start', marginTop: 20, paddingRight: 60}}>
                ...
                <View style={{
                    ...
                    <Text style={{fontSize: 12, color: 'white', alignSelf: 'flex-end', marginRight: 6, marginTop: -30}}>{data.datetime}</Text>
                </View>
            </View>
        );
    } else {
        return (
            <View style={{flexDirection: 'row', alignSelf: 'flex-start', marginTop: 20, paddingRight: 60}}>
                ...
                <View style={{
                    ...
                    <Text style={{fontSize: 12, color: '#bdbdbd', alignSelf: 'flex-end', marginRight: 6}}>{data.datetime}</Text>
                </View>
            </View>
        );
    }
    ...
    return (
        <View style={{
            ...
            <TouchableOpacity onPress={() => snackbarRef.current.ShowSnackBarFunction('Send clicked')}>
                <Image source={require('../../assets/icon/activity26_send_button.png')} style={{width: 36, height: 27}}/>
            </TouchableOpacity>
        </View>
    );
}

export default ActivityStyle26;