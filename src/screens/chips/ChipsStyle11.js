                ...
                renderItem={({item, index}) =>
                    <View style={{
                        ...
                        <Surface style={{
                            ...
                            <View style={{flex: 1, alignItems: 'center'}}>
                                ...
                                <Image style={{
                                    ...
                                    height:'100%'
                                       ...
                                       source={{uri: storageImageUrl('chip', 'chip_11_img_1.png')}}/>
                                <Text style={{fontSize: 20, color: '#FFF', marginTop: 50, fontWeight: 'bold'}}>Step
                                    1st</Text>
                                <Text style={{
                                    fontSize: 16,
                                    color: '#FFF',
                            ...
                            {/*<TouchableOpacity onPress={() => console.log('flatlistRef', flatlistRef)}*/}
                            <TouchableOpacity
                                onPress={() => {
                                    console.log('flatlistRef.current.snapToInterval', flatlistRef.current.snapToInterval);
                                    console.log('flatlistRef.current.snapToInterval', flatlistRef.current);
                                    if (page + 1 < dataArr.length) {
                                        flatlistRef.current.scrollToIndex({index: page + 1, animated: true});
                                        // flatlistRef.current = ({horizontal: false});
                ...
                dataArr.map((x, y) => {
                    return (
                        <View key={y} style={{
                            ...
                            width: 10,
                            marginRight: 10,
                            backgroundColor: page === y ? '#cd4dcc' : '#FFF',
                            // borderWidth: 1,
                            // borderColor: '#d3d3d3',
                            borderRadius: 20,
                        }}/>
