            ...
            <ModalContent visible={visible} onBackDropPress={() => setVisible(!visible)} style={{padding: 30}}>
                <Card style={{backgroundColor: '#FFF', minHeight: 300}}>
                    <View style={{flex: 2, alignItems: 'center', justifyContent: 'center'}}>
                        <Text style={{fontWeight: 'bold', fontSize: 14, color: '#3440db'}}>Congratulation</Text>
                        <Image style={{width: 75}} resizeMode={'contain'}
                               source={require('../../assets/dialog/025_trophy.png')}/>
                    </View>
                    <View style={{flex: 1, alignItems: 'center'}}>
                        <Text style={{fontWeight: 'bold', fontSize: 16, color:"#3c3c3c"}}>CHAMPION</Text>
