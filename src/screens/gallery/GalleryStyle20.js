...
function GalleryStyle20() {
    ...
    useEffect(() => {
        let newData = [];
        newData.push({id: '1', isSelected: false, image: 'gallery_20_img_1.jpg'});
        newData.push({id: '2', isSelected: false, image: 'gallery_20_img_2.jpg'});
        newData.push({id: '3', isSelected: false, image: 'gallery_20_img_3.jpg'});
        newData.push({id: '4', isSelected: false, image: 'gallery_20_img_4.jpg'});
        newData.push({id: '5', isSelected: false, image: 'gallery_20_img_5.jpg'});
        newData.push({id: '6', isSelected: false, image: 'gallery_20_img_6.jpg'});
        setDataEdit(newData);
    }, []);
...
function ItemData({data, onItemClick, numColumns}) {
    const wImage = (screenWidth / numColumns);
    const [hImage, setHImage] = useState(10);
    Image.getSize(storageImageUrl('gallery', data.image), (w, h) => {
