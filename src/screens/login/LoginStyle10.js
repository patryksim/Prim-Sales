...
import {Animated, Dimensions, ImageBackground, PanResponder, Text, View} from "react-native";
    ...
    render() {
        return (
            <Animated.View style={this.getMainCardStyle()} {...this.panResponder.panHandlers}>
                <Text style={{fontSize: 20, marginTop: 20, marginBottom: 10, alignSelf: 'center'}}>Sign Up</Text>
                ...
                <MaterialButton title='Create An Account' style={{backgroundColor: '#ff5722', marginTop: 25}}
                                buttonPress={() => this.props.onButtonClick('create account clicked')}/>
