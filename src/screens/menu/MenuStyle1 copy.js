...
const DATA = [
    {id: '1', title: 'activity1', bgColor: '#ff5722', icon: require('../../assets/icon/ic_menu1_photos.png')},
    {id: '2', title: 'music1', bgColor: '#00bfa5', icon: require('../../assets/icon/ic_menu1_videos.png')},
    {id: '3', title: 'ecommerce1', bgColor: '#7cb342', icon: require('../../assets/icon/ic_menu1_messages.png')},
    {id: '4', title: 'menu1', bgColor: '#448aff', icon: require('../../assets/icon/ic_menu1_settings.png')},
    {id: '5', title: 'profile1', bgColor: '#fbc02d', icon: require('../../assets/icon/ic_menu1_friends.png')},
    {id: '6', title: 'news1', bgColor: '#d81b60', icon: require('../../assets/icon/ic_menu1_notifs.png')},
];
