...
function MusicStyle4 () {
    ...
    return (
        <ImageBackground source={{uri: storageImageUrl('music', 'music_4_bg.jpg')}} style={{flex: 1, backgroundColor: '#f1f5f7'}}>
            <HeaderMusic
            ...
            />
            <View style={{flex: 1}}/>
            <Text style={{fontSize: 24, color: 'white', alignSelf: 'center', marginBottom: 5}}>Mouthful of Wasps</Text>
            <Text style={{fontSize: 14, color: 'white', alignSelf: 'center', marginBottom: 35}}>Kashmir</Text>
            <View style={{height: 125, backgroundColor: '#212121'}}/>
            <View style={{position: 'absolute', bottom: 0, left: 0, right: 0, height: 130}}>
                ...
                <View style={{
                    ...
                    <ControlButton image={isPlaying ? require('../../assets/icon/ic_pause2.png') : require('../../assets/icon/ic_play_white.png')} size={54}
...
function HeaderMusic({navPress, playlistPress, morePress}) {
    return (
        <View>
            <View style={{
                height: 56,
