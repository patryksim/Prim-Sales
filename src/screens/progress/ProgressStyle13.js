...
function ProgressStyle13() {
    ...
    return (
        <SwipeBackView style={{flex: 1, backgroundColor: '#2640e8', alignItems: 'center', paddingBottom: 42}}
            ...
            />
            <ViewPagerIndicator size={6} space={5} numPages={4} activeIndex={page} defaultColor='#162ec9' activeColor='#ffaf1d'/>
...
export default ProgressStyle13;