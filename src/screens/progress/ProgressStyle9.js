...
function ProgressStyle9() {
    ...
    return (
        <View style={{flex: 1, backgroundColor: '#dfe4eb'}}>
            ...
            />
            <View style={{width: '100%', flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 20, backgroundColor: '#fafafa'}}>
                ...
                <ViewPagerIndicator size={6} numPages={6} activeIndex={page} defaultColor='#e0e0e0' activeColor='#ffaf1d'/>
