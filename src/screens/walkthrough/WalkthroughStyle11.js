        ...
        <SwipeBackView style={{flex: 1, alignItems: 'center', backgroundColor: '#f1f5f7'}} onSwipeBack={() => pageContext.pageDispatch({page: 'pop'})}>
            ...
            <View style={{padding: 10}}>
                <View style={{flexDirection: 'row'}}>
                    <MaterialButton title='SIGN UP' style={{flex: 1, height: 44, backgroundColor: 'white', marginRight: 10, marginTop: 10}}
                                    buttonPress={() => snackbarRef.current.ShowSnackBarFunction('Sign Up clicked')}/>
                    <MaterialButton title='SIGN IN' style={{flex: 1, height: 44, backgroundColor: 'white', marginTop: 10}}
                                    buttonPress={() => snackbarRef.current.ShowSnackBarFunction('Sign In clicked')}/>
                </View>
                <MaterialButton title='Sign Up with Facebook' style={{width: screenWidth - 20, height: 44, backgroundColor: '#3f569a', marginTop: 10}}
    ...
    return (
        <View style={{
            ...
            <Image source={require('../../assets/icon/ic_headphone_red.png')}
                   style={{height: 100, width: 100, resizeMode: 'contain', marginBottom: 60}}/>
...
export default WalkthroughStyle11;