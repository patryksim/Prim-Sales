...
const bgHeight = Dimensions.get('window').height - 250;

function WalkthroughStyle5() {
...
function PageItem() {
    return (
        <View style={{
            ...
            <Image source={{uri: storageImageUrl('walkthrough', 'walkthrough_5_960.jpg')}}
                   style={{height: bgHeight, width: screenWidth, resizeMode: 'cover'}}/>
        </View>
    );
}

export default WalkthroughStyle5;